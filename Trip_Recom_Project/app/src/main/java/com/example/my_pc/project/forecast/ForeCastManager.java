package com.example.my_pc.dbproject.forecast;
...
import com.example.my_pc.dbproject.activity.WeatherActivity;
...
public class ForeCastManager extends Thread {
    ...
    public ForeCastManager(String cityname, WeatherActivity mContext)
    {
    ...
    public ArrayList<ContentValues> GetOpenWeather(String cityname)
    {
        String city;
        ArrayList<ContentValues> mTotalValue = new ArrayList<ContentValues>();
        String key = "9ab7df90adbab72249f8c18d95ccef5f";
        try{
    ...
    public void run() {
        ...
        mWeather = GetOpenWeather(cityname);
